...
if __name__ == "__main__":
    ...
    if not os.path.exists("./results/10"):
        os.makedirs("./results/10")

    if args.save_model and not os.path.exists("./models/10"):
        os.makedirs("./models/10")
    ...
    if args.load_model != "":
        ...
        for t in range(int(args.max_timesteps)):
            ...
            if (t + 1) % args.eval_freq == 0:
                ...
                np.save(f"./results/10/{file_name}", evaluations)
                if args.save_model: policy.save(f"./models/10/{file_name}")